...
public class ProductService {
    ...
    public Page<ProductResponseDto> getProductList(User user, int page, int size, String sortBy, boolean isAsc) {
    ...
    public Page<ProductResponseDto> getProductsInFolders(Long folderId, int page, int size, String sortBy, boolean isAsc, User user) {
        Sort.Direction direction = isAsc ? Sort.Direction.ASC : Sort.Direction.DESC;
        Sort sort = Sort.by(direction, sortBy);
        Pageable pageable = PageRequest.of(page, size, sort);
